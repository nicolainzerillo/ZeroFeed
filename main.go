...
func generateChannelCode() string {
	words := []string{
		...
		"monolith", "navigator", "obsidian", "pyramid", "quest", "rift", "spire", "tempest",
		"utopia", "vanguard", "wildfire", "zealot", "asteroid", "blizzard", "cosmos", "dynamo",
		...
		"ultraviolet", "volcano", "viper", "whirlpool", "xiphos", "yggdrasil", "zircon", "apex",
		"bastion", "citadel", "domain", "empire", "fortress", "guardian", "hyperion", "isotope",
		"juggernaut", "kryptonite", "labyrinth", "meridian", "nemesis", "oracle", "pathfinder", "quicksilver",
		"renegade", "sentinel", "torpedo", "universe", "vulture", "warlord", "xenonite", "yottabyte",
		...
		"qubit", "raytrace", "singularity", "thruster", "unifier", "veritas", "warp", "xanadu",
		"yearling", "zeropoint", "arc", "bolt", "core", "disk", "flux", "gate",
		"hub", "ion", "jet", "kilobyte", "link", "mesh", "node", "overdrive",
		"port", "quad", "ram", "sync", "turboflow", "unit", "volt", "watt",
		"xenith", "yaw", "zone", "alpha", "beta", "gamma", "delta", "epsilon",
		"zeta", "eta", "theta", "iota", "kappa", "lambda", "mu", "nu",
		"xi", "omicron", "pi", "rho", "sigma", "tau", "upsilon", "phi",
		"chi", "psi", "omegacore", "antimatter", "biome", "chronos", "darkmatter", "exoplanet",
	}
